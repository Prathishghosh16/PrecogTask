...
- Metrics such as Modularity, diameter and centrality were calculated seperately for each of the components and visualised through plots.![[modularity_formula.png]]
